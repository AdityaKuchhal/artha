...
SUBSCRIPTION_PATTERNS = [
    ...
    "disney", "hulu", "youtube", "microsoft", "adobe",
    "dropbox", "slack", "notion", "github", "openai",
    "chatgpt", "cursor", "figma", "canva", "grammarly",
]
    ...
    for txn in raw_transactions:
        ...
        structured.append({
            ...
            "category": txn.personal_finance_category.primary
                if hasattr(txn, 'personal_finance_category')
                and txn.personal_finance_category else "UNCATEGORIZED",
