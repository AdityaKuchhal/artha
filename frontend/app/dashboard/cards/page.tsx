                ...
                >
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '16px' }}>
                    {[
                      {
                        label: 'Earned',
                        value: formatCurrency(jobEarnings?.earnings || 0),
                        color: 'var(--green)',
                      },
                      {
                        label: 'Hours',
                        value: `${jobEarnings?.hours || 0}h`,
                        color: 'var(--text)',
                      },
                      {
                        label: 'Shifts',
                        value: String(jobEarnings?.shifts || 0),
                        color: 'var(--text)',
                      },
            ...
            {jobs.length === 0 && (
              ...
              >
                ...
                <div style={{ color: 'var(--text3)', fontSize: '13px' }}>
                  Add your part-time jobs to track income
                </div>
              </div>
            )}
          </div>
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        {account.synced_count !== undefined && (
          <div style={{ fontSize: '12px', color: 'var(--text3)', marginTop: '2px' }}>
            {account.synced_count} transactions synced
          </div>
        )}
      </div>
      <div
...
function RecentShifts({
  ...
  const ShiftForm = (
    <form onSubmit={handleSubmit} className="card" style={{ marginBottom: '16px' }}>
      <div
        style={{ fontSize: '13px', fontWeight: 600, color: 'var(--text)', marginBottom: '16px' }}
      >
        ...
        >
          ...
          <div>
            ...
            <div style={{ fontSize: '11px', color: 'var(--text3)', marginTop: '6px' }}>
              {breakPaid
                ? 'Paid break — not deducted from earnings'
