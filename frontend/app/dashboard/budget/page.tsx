...
const CATEGORIES = [
  ...
  'GENERAL_MERCHANDISE', 'PERSONAL_CARE', 'ENTERTAINMENT',
  'TRAVEL', 'LOAN_PAYMENTS',
]
    ...
    <div className="page fade-up">
      ...
      <div className="grid-3">
        ...
        <div className="card">
          ...
          <div className="metric-value" style={{ color: totalSpent > totalBudgeted ? 'var(--red)' : 'var(--text)' }}>
        ...
        <div className="card">
          ...
          <div className="metric-value" style={{ color: overBudgetCount > 0 ? 'var(--red)' : 'var(--green)' }}>
            {overBudgetCount}
          </div>
          <div className="metric-label">{overBudgetCount === 0 ? 'All within limits' : 'Categories exceeded'}</div>
        </div>
      </div>
        ...
        <form onSubmit={addBudget} className="card">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
            ...
            <div>
              ...
              <input className="input" type="number" step="0.01" value={limit} onChange={e => setLimit(e.target.value)} placeholder="400" required />
            </div>
          </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
        {budgets.length === 0 ? (
          <div className="card" style={{ textAlign: 'center', padding: '48px' }}>
            ...
            <div style={{ color: 'var(--text)', fontWeight: 600, marginBottom: '4px' }}>No budgets set</div>
            <div style={{ color: 'var(--text3)', fontSize: '13px' }}>Set monthly limits to track your spending</div>
          </div>
        ) : budgets.map(budget => {
          ...
          return (
            <div key={budget.id} className="card" style={{ padding: '18px 22px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '14px' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                  <div style={{ textAlign: 'right' }}>
                    <div style={{ fontSize: '14px', fontWeight: 700, color: isOver ? 'var(--red)' : 'var(--text)' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '11px', color: 'var(--text3)', marginTop: '6px' }}>
